			...
			content = (
				<div className='editor-window'>
					<div className="library-blocks">
						<div className="block" onClick={() => {this.props.changeBlockType('begin')}}>
							<svg width='120' height='90'>
								<ellipse cx='60' cy='50' rx='50' ry='25' fill='#ccc'/>
							</svg>
							<p>Begin</p>
						</div>
						<div className="block" onClick={() => {this.props.changeBlockType('end')}}>
							<svg width='120' height='90'>
								<ellipse cx='60' cy='50' rx='50' ry='25' fill='#ccc'/>
							</svg>
							<p>End</p>
						</div>
						<div className="block" onClick={() => {this.props.changeBlockType('process')}}>
							<svg width='120' height='90'>
								<rect x="5" y="30" width="110" height="70" fill='#ccc'/>
							</svg>
							<p>Process</p>
						</div>
						<div className="block" onClick={() => {this.props.changeBlockType('decision')}}>
							<svg width='120' height='90'>
